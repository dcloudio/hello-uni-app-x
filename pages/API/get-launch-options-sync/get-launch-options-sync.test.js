...
const isHarmony = process.env.uniTestPlatformInfo.toLocaleLowerCase().startsWith('harmony')
const HOME_PATH = isDom2 && !isHarmony ? '/pages/tabBar/tab-bar' : '/pages/tabBar/component'
